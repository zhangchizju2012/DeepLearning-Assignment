...
datapath = homepath + "DeepLearning-Assignment/a1/data1/cifar-10-batches-py"
...
# plot bounds
YMAX_TRAIN = 100000.0#10000.0
YMAX_VALID = 10000#200.0
YMAX_TEST  = 10000#400.0
...
data_train_mat, data_valid_mat, data_test_mat = util1.read_cifar.load_CIFAR10(datapath)
...
pickle.dump( [means, FILELABEL, FILETAG], open( "save_cifar.p", "wb" ) )
